...
import { ReactComponent as RawOpenAIIcon } from '@renderer/assets/img/openai.svg'
...
const OpenAIIntro = (): JSX.Element => {
  const handleClickAncher: MouseEventHandler<HTMLAnchorElement> = (e) => {
    e.preventDefault()
    window.electron.ipcRenderer.invoke('openBrowser', e.currentTarget.href)
  }
  return (
    <TooltipUI.Provider>
      <TooltipUI.Root>
